...
$ helm install hugo-theme hub-dev/hugo-theme
```
...
To install the chart with the release name `hugo-theme`:

```console
helm install hugo-theme hub-dev/hugo-theme -n dev
```

The command deploys `hugo-theme` on the Kubernetes cluster in the default configuration. The [Parameters](#parameters) section lists the parameters that can be configured during installation.

> **Tip**: List all releases using `helm list -A`

## Uninstalling the Chart

To uninstall/delete the `hugo-theme` deployment:

```console
helm delete hugo-theme
```
